...
public class CreateTravelRequestRequestValidator : AbstractValidator<CreateTravelRequestRequest>
{
    public CreateTravelRequestRequestValidator()
    {
    ...
    private static bool HaveValidDateRange(CreateTravelRequestRequest request)
    {
        return request.DateFrom < request.DateTo;
    }

    private static bool HaveDifferentCities(CreateTravelRequestRequest request)
    {
